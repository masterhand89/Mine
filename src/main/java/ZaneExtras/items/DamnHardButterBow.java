...
public class DamnHardButterBow extends Item
	{
		public static final String[] bowPullIconNameArray = new String[]{
				"pulling0", "pulling1", "pulling2"};

		@SideOnly(Side.CLIENT)
		private Icon[] iconArray;

		public DamnHardButterBow(int par1)
			{
				super(par1);
				this.maxStackSize = 1;
				this.setMaxDamage(984);
				this.setUnlocalizedName("damnhardbutterbow");
				this.setCreativeTab(ModTabs.zaneTab);
				this.setTextureName("Zane Extras:damnhardbutterbow");
			}
		/**
		...
		public void onPlayerStoppedUsing(ItemStack par1ItemStack,
				World par2World, EntityPlayer par3EntityPlayer, int par4)
			{
		...
		public void registerIcons(IconRegister par1IconRegister)
			{
				this.itemIcon = par1IconRegister
						.registerIcon("Zane Extras:damnhardbutterbowstandby");
				this.iconArray = new Icon[bowPullIconNameArray.length];
				for (int i = 0; i < this.iconArray.length; ++i)
					{
						this.iconArray[i] = par1IconRegister
								.registerIcon("Zane Extras:damnhardbutterbow"
