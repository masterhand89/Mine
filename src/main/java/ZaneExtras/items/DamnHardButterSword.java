...
public class DamnHardButterSword extends Item
	{
		private float weaponDamage;
		private final EnumToolMaterial toolMaterial;

		public DamnHardButterSword(int par1,
				EnumToolMaterial par2EnumToolMaterial)
			{
				...
				this.setUnlocalizedName("damnhardbuttersword");
				this.weaponDamage = 7.0F + par2EnumToolMaterial
						.getDamageVsEntity();
				this.setTextureName("Zane Extras:damnhardbuttersword");
			}
		...
		public boolean onBlockDestroyed(ItemStack par1ItemStack,
			...
			{
				if ((double) Block.blocksList[par3].getBlockHardness(par2World,
						par4, par5, par6) != 0.0D)
					{
		...
		public boolean getIsRepairable(ItemStack par1ItemStack,
			...
			{
				return this.toolMaterial.getToolCraftingMaterial() == par2ItemStack.itemID
						? true
						: super.getIsRepairable(par1ItemStack, par2ItemStack);
			}
		/**
		 * Gets a map of item attribute modifiers, used by ItemSword to increase
		 * hit damage.
		 */
